            ...
            <div className="overflow bg-black">
                ...
                <div className="Card1">
                    <div class="row">
                        <div class="col-sm-3">
                            <Link to={"/playlist/"+1}>
                                <img src={Rock1} class="img-fluid rounded-start card-img"></img>
                                <h4 className="art1">Manu</h4>
                            </Link>
                        </div>
                        <div class="col-sm-3">
                            <Link to="/playlist">
                                <img src={Pop1} height="322px" width="210px" class="card-img"></img>
                                <h4 className="art2">HAASH</h4>
                            </Link>
                        </div>
                        <div class="col-sm-3">
                            <Link to="/playlist">
                                <img src={Pop2} height="322px" width="210px" class="card-img"></img>
                                <h4 className="art3">Morat</h4>
                            </Link>
                        </div>
                        <div class="col-sm-3">
                            <Link to="/playlist">
                                <img src={Pop4} height="324px" width="210px" class="card-img"></img>
                ...
                <div className="Card2">
                    <div class="row">
                        <div class="col-sm-3">
                            <Link to="/playlist">
                                <img src={Clasic1} height="322px" width="210px" class="card-img"></img>
                                <h5 className="art5">Jose Jose</h5>
                            </Link>
                        </div>
                        <div class="col-sm-3">
                            <Link to="/playlist">
                                <img src={Clasic2} height="322px" width="210px" class="card-img"></img>
                                <h5 className="art6">Juan Gabriel</h5>
                            </Link>
                        </div>
                        <div class="col-sm-3">
                            <Link to="/playlist">
                            <img src={Clasic3} height="322px" width="210px" class="card-img"></img>
                            <h5 className="art7">Amanda Miguel</h5>
                            </Link>
                        </div>
                        <div class="col-sm-3">
                            <Link to="/playlist">
                            <img src={Clasic4} height="322px" width="210px" class="card-img"></img>
                ...
                <div className="Card2">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src={Cumbia1} height="322px" width="210px" class="card-img"></img>
                            <h5 className="art9">Apache</h5>
                        </div>
                        <div class="col-sm-3">
                            <img src={Cumbia2} height="322px" width="210px" class="card-img"></img>
                            <h5 className="art10">Angeles Azules</h5>
                        </div>
                        <div class="col-sm-3">
                            <img src={Cumbia3} height="322px" width="210px" class="card-img"></img>
                            <h5 className="art11">Celso Piña</h5>
                        </div>
                        <div class="col-sm-3">
                            <img src={Cumbia4} height="322px" width="210px" class="card-img"></img>
                ...
                <div className="container-fluid bg-black ">
                    ...
                    <div className="row p-3 pb-4 justifiy-content-center">
                        <div className="col g-0">
                            <img src={rock} alt="Rock" className="img-fluid w-75" class="card-img"></img>
                        </div>
                        <div className="col g-0">
                            <img src={pop} alt="Pop" className="img-fluid w-75" class="card-img"></img>
                        </div>
                    </div>

                    <div className="row p-3 pb-3 justifiy-content-center">
                        <div className="col g-0">
                            <img src={clasica} alt="Clasica" className="img-fluid w-75 " class="card-img"></img>
                        </div>
                        <div className="col g-0">
                            <img src={cumbia} alt="Cumbia" className="img-fluid w-75 " class="card-img"></img>
                        </div>
                    </div>
                </div>
